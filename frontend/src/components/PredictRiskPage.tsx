...
type PredictRiskPageProps = {
  latestPrediction: Prediction | null;
  onNewPrediction: (prediction: Omit<Prediction, "date">) => void;
};

const API_BASE_URL = "http://localhost:8000";

export const PredictRiskPage: React.FC<PredictRiskPageProps> = ({
  latestPrediction,
  onNewPrediction,
}) => {
  ...
  const [result, setResult] = useState<PredictionResponse | null>(
    latestPrediction
      ? {
          feature_name: latestPrediction.feature_name,
